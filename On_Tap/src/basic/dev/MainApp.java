...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Tuoi: " + (2022 - age));
		...
		int chu_vi = (a + b) * 2;
		int dien_tich = a * b;
		System.out.println("Chu vi hinh chu nhat: " + chu_vi);
		System.out.println("Dien tich hinh chu nhat: " + dien_tich);
		...
		System.out.println("Nhap so chia het cho 5: ");
